...
Resource.create(name: 'Stack Overflow', link: 'https://stackoverflow.com', skill_id: a.id, text: "That super cool website that everyone uses all the time to fix errors.")
Resource.create(name: 'Faker', link: 'https://github.com/stympy/faker', skill_id: a.id, text: "A cool Ruby gem that you can use to make things up to stub out data when working on a project. Very useful in creating useful mocups.")
Resource.create(name: 'Corneal', link: 'https://github.com/thebrianemory/corneal', skill_id: c.id, text: 'A Sinatra file structure generator! Made by a fellow FlatIron student.')
Resource.create(name: "Improving Rest Calls with ngResource", link: 'https://devdactic.com/improving-rest-with-ngresource/', text: 'A useful summary of how to take advantage of the AngularJS module  angular-resource (ngResource). By using ngResource instead of your regular $http calls, you can make your code more RESTful. This guide shows you have to make a $resource call with extra parameters and how to refer to it.', skill_id: e.id)
