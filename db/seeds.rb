...
h = Resource.create(name: 'Stack Overflow', link: 'https://stackoverflow.com', text: "That super cool website that everyone uses all the time to fix errors.")
i = Resource.create(name: 'Faker', link: 'https://github.com/stympy/faker', text: "A cool Ruby gem that you can use to make things up to stub out data when working on a project. Very useful in creating useful mocups.")
j= Resource.create(name: 'Corneal', link: 'https://github.com/thebrianemory/corneal', text: 'A Sinatra file structure generator! Made by a fellow FlatIron student.')
k = Resource.create(name: "Improving Rest Calls with ngResource", link: 'https://devdactic.com/improving-rest-with-ngresource/', text: 'A useful summary of how to take advantage of the AngularJS module  angular-resource (ngResource). By using ngResource instead of your regular $http calls, you can make your code more RESTful. This guide shows you have to make a $resource call with extra parameters and how to refer to it.')
