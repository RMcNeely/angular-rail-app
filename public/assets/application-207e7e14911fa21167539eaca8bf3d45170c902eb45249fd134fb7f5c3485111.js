...
// source: app/assets/javascripts/templates/about.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("about.html", '<div class="container-fluid">\n  <div class="">\n    <p>\n      This is a collection of Languages, Frameworks, computer technologies and other various resources compiled by and for the students at FlatIron School. Slightly prettier than a Google Doc. \n    </p>\n  </div>\n</div>')
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("home.html", '<div ng-include="\'navbar.html\'"></div>\n<div class="row">\n  <div class="col s2">\n  </div>\n\n  <div class="col s9">\n    <h3>\n      Welcome to Learn-source!\n    </h3>\n\n    <h6>\n      The complete collection of student resources to accompany lessons at FlatIron School\n    </h6>\n\n  </div>\n\n</div>\n<div class="row" ui-view>\n\n</div>')
}]);
...
angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("navbar.html", "<nav>\n  <div class=\"nav-wrapper \">\n    <a href=\"#\" ui-sref=\"home\" du-scrollspy='' du-smoothscroll='' class=\"brand-logo wrap\">Learn-Source</a>\n    <a href=\"#\" data-activates=\"slide-out\" class=\"button-collapse\"><i class=\"material-icons\">Menu</i></a>\n    <ul class=\"right hide-on-med-and-down section scrollspy\">\n      <li><a du-scrollspy='' du-smoothscroll='' href=\"#skills\" ui-sref='home.skill' id='skills'>Skills</a></li>\n      <li><a du-scrollspy='' du-smoothscroll='' href=\"#resources\" ui-sref='home.resources' id='resources'>Resources</a></li>\n    </ul>\n    <ul class=\"side-nav section scrollspy\" id=\"slide-out\">\n      <li><a du-scrollspy='' du-smoothscroll='' href=\"#skills\" du-scrollspy id='skills' ui-sref='home.skill'>Skills</a></li>\n      <li><a du-scrollspy='' du-smoothscroll='' href=\"#resources\" du-scrollspy ui-sref=\"home.resources\" id='resources' >Resources</a></li>\n    </ul>\n  </div>\n</nav>")
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/resources/new.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("resources/new.html", '<div class="card blue-grey darken-1">\n\n<form name=newResource ng-submit="ctrl.formSubmit(ctrl.newResource)">\n\n  <div class="input-field">\n    <label for="newResource.name">Name:</label><br>\n    <input ng-model=\'ctrl.newResource.name\'\n      type="text"\n      name="name"\n      required="required" />\n  </div>\n\n\n    <div ngMessages="form.newResource.name.$error" ng-if=\'newResource.name.$dirty\'>\n          <div ngMessages="required">\n              A name is required!\n          </div>\n    </div>\n\n    <div class="input-field">\n      <label for="newResource.name">Description:</label><br><br>\n      <textarea ng-model=\'ctrl.newResource.description\'\n        name="name"\n        minlength="20"\n        required="required"></textarea>\n\n        <div ngMessages="form.newResource.description.$error" ng-if=\'newResource.text.$dirty\'>\n            <div ngMessages="required">\n                A description is required!\n            </div>\n            <div ngMessages="minlength">\n              The description must be long enough!\n            </div>\n        </div>\n    </div>\n\n    <div class="input-field">\n      <label for="newResource.link">Skill Link:</label><br>\n      <input ng-model=\'ctrl.newResource.link\'\n        type="url"\n        name="link"\n        minlength="6"\n        required="required" />\n    </div>\n\n        <div ngMessages="form.newResource.link.$error" ng-if=\'newResource.link.$dirty\'>\n            <div ngMessages="required">\n                A link is required!\n            </div>\n            <div ngMessages="minlength">\n              The link must be long enough!\n            </div>\n        </div>\n\n<div class="input-field">\n  <span ng-repeat=\'skill in ctrl.skills\'>\n    <input type="checkbox" checklist-model=\'ctrl.newResource.tags\' checklist-value=\'skill.id\' id="{{skill.id}}" ng-change="check(skill, checked)">\n    <label for="{{skill.id}}">\n    {{skill.name}}\n    </label>\n  </span>\n</div>\n  <br><br>\n\n  <input\n        class="waves-effect deep-orange btn below "\n        type="submit"\n        value="Create"  />\n\n</form>\n\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/resources/resources.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("resources/resources.html", '<div class="col s2">\n</div>\n\n\n<div class="col s9">\n  <h3>\n    Resources\n  </h3>\n  <input type="text" name="ctrl-search" ng-model="ctrl.search" />\n</div>\n\n<div class="col s2">\n</div>\n\n<div class="col s9">\n\n  <div ng-repeat="resource in ctrl.resources | filter:ctrl.search ">\n\n    <div class="row">\n        <div class="col s12 m6">\n          <div class="card blue-grey darken-1">\n            <div class="card-content white-text">\n              <a href="#" ui-sref="resource({id: resource.id})"><span class="card-title">{{resource.name}}</span></a>\n              <span id=\'favorite\'>\n                <strong ng-click="ctrl.addFavorite(resource)">Favorite Me!</strong><br>\n                {{resource.favorite}} Favorites\n              </span>\n              <p>{{resource.description}}</p>\n            </div>\n            <div class="card-action">\n              <a ng-href="{{resource.link}}">Visit  {{resource.name}}.</a><br>\n\n\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n  </div>\n\n  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">\n     <a ui-sref="home.resources.new"class="btn-floating btn-large red">\n       <i class="large material-icons">mode_edit</i>\n     </a>\n   </div>\n\n   <div ui-view></div>\n\n\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/resources/show.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("resources/show.html", '<div ng-include="\'navbar.html\'"></div>\n\n<div class="row">\n    <div class="col s12 m6">\n      <div class="card blue-grey darken-1" >\n        <div class="card-content white-text">\n          <span class="card-title">{{ctrl.resource.name}}</span>\n          <p>{{ctrl.resource.description}}</p>\n        </div>\n        <div class="card-action">\n          <a ng-href="{{ctrl.resource.link}}">Visit the  {{ctrl.resource.name}} website</a><br>\n          <a ng-href="{{ctrl.resource.documentation_link}}" target="_blank" ng-if ="ctrl.resource.documentation_link !=null" >Read the documentation</a><br>\n          <!-- <a href="#">Browse Resources</a> -->\n          <div ui-view></div>\n        </div>\n      </div>\n    </div>\n  </div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/skills/new.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("skills/new.html", '<div class="card blue-grey darken-1">\n\n\n<div >\n  <h4>Add a new Skill:</h4>\n  <form name=newSkill ng-submit="ctrl.formSubmit(ctrl.newSkill)">\n\n  <div class="input-field">\n    <label for="newSkill.name">Name:</label><br>\n    <input ng-model=\'ctrl.newSkill.name\'\n      type="text"\n      name="name"\n      required="required" />\n  </div>\n\n\n        <div ngMessages="form.newSkill.name.$error" ng-if=\'newSkill.name.$dirty\'>\n            <div ngMessages="required">\n                A name is required!\n            </div>\n        </div><br><br>\n\n    <div class="input-field">\n      <label>Select Category:</label><br><br>\n        <!-- <input ng-model=ctrl.newSkill.category class=\'text\' name="category" value="category"> -->\n        <select ng-model=\'ctrl.newSkill.category\' class=\'browser-default\' >\n          <option ng-option="cat.value in ctrl.categories">{{cat.value}}</option>\n            <option value="" disabled selected>Choose your option</option>\n            <option name=\'language\' value="language">Language</option>\n            <option name=\'framework\' value="framework">Framework</option>\n            <option value="technology">Technology</option>\n            <option value="miscellaneous">Miscellaneous</option>\n          </select>\n\n    </div><br>\n\n\n  <div class="input-field">\n    <label for="newSkill.description">Description:</label><br><br>\n    <textarea ng-model=\'ctrl.newSkill.description\'\n      name="name"\n      minlength="20"\n      required="required"></textarea>\n  </div>\n\n      <div ngMessages="form.newSkill.description.$error" ng-if=\'newSkill.description.$dirty\'>\n          <div ngMessages="required">\n              A description is required!\n          </div>\n          <div ngMessages="minlength">\n            The description must be long enough!\n          </div>\n      </div>\n\n\n  <div class="input-field">\n    <label for="newSkill.link">Skill Link:</label><br>\n    <input ng-model=\'ctrl.newSkill.link\'\n      type="url"\n      name="link"\n      minlength="6"\n      required="required" />\n  </div>\n\n      <div ngMessages="form.newSkill.link.$error" ng-if=\'newSkill.link.$dirty\'>\n          <div ngMessages="required">\n              A link is required!\n          </div>\n          <div ngMessages="minlength">\n            The link must be long enough!\n          </div>\n      </div>\n\n\n  <div class="input-field">\n    <label for="newSkill.documentation_link">Documentation Link:</label><br>\n    <input ng-model=\'ctrl.newSkill.documentation_link\'\n      type="url"\n      name="documentationLink"/>\n      {{ctrl.skopeName}}\n  </div>\n\n  <div class="input-field">\n    <label for="newSkill.version">Version (if applicable):</label><br>\n    <input ng-model=\'ctrl.newSkill.version\'\n      type="text"\n      name="version" />\n  </div>\n\n  <div class="input-field">\n    <span ng-repeat=\'resource in ctrl.resources\'>\n      <input type="checkbox" checklist-model=\'ctrl.newSkill.tags\' checklist-value=\'resource.id\' id="{{resource.id}}" ng-change="check(resource, checked)">\n      <label for="{{resource.id}}">\n      {{resource.name}}\n      </label>\n    </span>\n  </div>\n    <br><br>\n\n    <!-- <button ng-submit=ctrl.newSkill class="btn waves-effect waves-light" type="submit" name="action">Submit\n      <i class="material-icons right">send</i>\n    </button> -->\n\n    <input\n          class="waves-effect deep-orange btn below "\n          type="submit"\n          value="Create"  />\n\n  </form>\n\n</div>\n\n\n</div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/skills/show.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("skills/show.html", '<div ng-include="\'navbar.html\'"></div>\n\n<div class="row">\n    <div class="col s12 m6">\n      <div class="card blue-grey darken-1" >\n        <div class="card-content white-text">\n          <span class="card-title">{{ctrl.skill.name}}</span>\n          <p>{{ctrl.skill.description}}</p>\n        </div>\n        <div class="card-action">\n          <a ng-href="{{ctrl.skill.link}}">Visit the  {{ctrl.skill.name}} website</a><br>\n          <a ng-href="{{ctrl.skill.documentation_link}}" target="_blank" ng-if ="ctrl.skill.documentation_link !=null" >Read the documentation</a><br>\n          <!-- <button ng-click="showResources">Browse Resources</button> -->\n          <skill-resources></skill-resources>\n        </div>\n      </div>\n    </div>\n  </div>')
}]);

// Angular Rails Template
// source: app/assets/javascripts/templates/skills/skills.html

angular.module("templates").run(["$templateCache", function($templateCache) {
  $templateCache.put("skills/skills.html", '<div class="col s2">\n</div>\n\n\n<div class="col s9">\n  <h3>\n    All Skills\n  </h3>\n  <input type="text" name="ctrl-search" ng-model="ctrl.search" />\n</div>\n\n<div class="col s2">\n</div>\n\n<div class="col s9">\n\n  <div ng-repeat="skill in ctrl.skills | filter:ctrl.search ">\n\n    <div class="row">\n        <div class="col s12 m6">\n          <div class="card blue-grey darken-1" >\n            <div class="card-content white-text">\n              <a href="#" ui-sref=\'skill({id: skill.id})\'><span class="card-title">{{skill.name}}</span></a>\n              <span id=\'favorite\'>\n                <strong ng-click="ctrl.addFavorite(skill)">Favorite Me!</strong><br>\n                {{skill.favorite}} Favorites\n              </span>\n              <p>{{skill.description}}</p>\n\n              <span id=\'favorite\'>\n                <strong ng-click="ctrl.decreaseFavorite(skill)">Remove Favorite</strong><br>\n            </div>\n            <div class="card-action">\n              <a ng-href="{{skill.link}}">Visit the  {{skill.name}} website</a><br>\n              <a ng-href="{{skill.documentation_link}}" target="_blank" ng-if ="skill.documentation_link !=null" >Read the documentation</a><br>\n\n            </div>\n          </div>\n        </div>\n      </div>\n\n\n  </div>\n\n  <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">\n     <a ui-sref="home.skill.new"class="btn-floating btn-large red">\n       <i class="large material-icons">mode_edit</i>\n     </a>\n   </div>\n\n  <!-- <a ui-sref=\'home.skill.new\' class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">+</i></a> -->\n  <div ui-view>\n  </div>\n\n</div>\n<!-- ng-href="#/{{ctrl.skopeName}}/resources" -->')
}]);
